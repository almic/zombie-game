...
func load_stream() -> AudioStreamOggVorbis:
    push_error('Cannot call "load_stream()" on SoundResourceChoice!')
    return null
...
func load_stream_async() -> bool:
    push_error('Cannot call "load_stream_async()" on SoundResourceChoice!')
    return false

## Unloads the stream
func unload_stream() -> void:
    push_error('Cannot call "unload_stream()" on SoundResourceChoice!')

## Get the audio stream, returns null if not loaded
func get_stream() -> AudioStreamOggVorbis:
    push_error('Cannot call "get_stream()" on SoundResourceChoice!')
    return null
...
func is_stream_ready() -> bool:
    push_error('Cannot call "is_stream_ready()" on SoundResourceChoice!')
    return false
